...
let regex1 = /^[a-z]$/; // checks if first word is [a to z], // // indicates start of regex, ^ indicates start of string, $ indicates end of string
...
/*
 Regex to check whether string contains at least
 1 lowercase, 1 uppercase, 1 symbol, 1 digit and must be
 8 characters long
*/
